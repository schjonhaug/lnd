...
func GossipSync(cacheDir string, dataDir string, networkType string, callback Callback) {
	var (
		...
		breezURL      = "https://speedloader.lnolymp.us/mainnet/graph/graph-001d.db"
		patchURL      = "https://speedloader.lnolymp.us/mainnet/graph/"
		checksumURL   = "https://speedloader.lnolymp.us/mainnet/graph/MD5SUMS"
